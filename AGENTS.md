...
- Use the official MCP SDK v2 pinned to the modern `2026-07-28` protocol revision only. Do not negotiate or fall back to the legacy 2025 wire era. The first implementation supports Streamable HTTP, `tools/list`, and `tools/call`; defer stdio, deprecated HTTP+SSE, OAuth UI, resources, prompts, tasks, sampling, elicitation, and arbitrary headers.
