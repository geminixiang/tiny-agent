...
test("source prose and interface strings use zh-TW", async () => {
    const deny = [
        "章节", "筛选", "复制", "软件工程师", "代码", "数据", "文件", "服务器", "连接", "执行结果", "错误信息", "验证", "测试计划", "系统", "创建", "支持", "设置", "当前", "开始", "学习路径", "页面", "链接", "用户", "实现", "调用", "返回", "历史", "默认", "继续阅读", "加载", "读取", "档案", "进程", "恢复", "必须", "应该", "不会", "这些", "这个", "之后", "来自", "显示", "选择", "完整目录", "没有符合", "输入关键词", "分钟", "繁体中文（台湾）", "几十", "精确", "可见", "隐藏", "复杂", "阅读", "什么", "认识", "这样", "给", "触碰", "机会", "补出", "维护", "当测试", "等价", "尽力", "终止", "三条", "两者", "Repo内", "适配", "占用", "步骤", "成长", "下一轮", "变长", "减少", "单独", "规則",
    ];
    const sourceFiles = [
        join(root, "README.md"),
